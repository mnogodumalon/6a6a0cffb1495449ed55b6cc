...
export function SachbearbeiterDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: SachbearbeiterDialogProps) {
  ...
  const DIALOG_INTENT = defaultValues ? 'Sachbearbeiter bearbeiten' : 'Sachbearbeiter hinzufügen';
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          id="email"
          type="email"
          placeholder="z. B. max.mueller@beispiel.de"
          value={fields.email ?? ''}
    ...
    'abteilung': (
      <div key="abteilung" className="space-y-1.5">
        ...
        <Input
          id="abteilung"
          placeholder="z. B. Fachbereich Kultur"
    ...
    'funktion': (
      <div key="funktion" className="space-y-1.5">
        <Label htmlFor="funktion">Funktion / Rolle</Label>
        <Input
          id="funktion"
          placeholder="z. B. Sachbearbeiter Anträge"
